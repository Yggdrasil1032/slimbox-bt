...
static void handle_buttons() {
    ...
    int dpad = gpio_pin_get_dt(&buttons[8]) | (gpio_pin_get_dt(&buttons[6]) << 1) | (gpio_pin_get_dt(&buttons[7]) << 2) | (gpio_pin_get_dt(&buttons[9]) << 3);
